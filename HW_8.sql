...
-- После разбора ДЗ и рекомендаций ***************************************************************************************** 
SELECT
...
-- ********   доработаный вариант после проверки   *****************************************************************
SELECT 
...
FROM users u LEFT JOIN posts p ON u.id = p.user_id AND p.created_at BETWEEN "2000-01-01" AND now() 
